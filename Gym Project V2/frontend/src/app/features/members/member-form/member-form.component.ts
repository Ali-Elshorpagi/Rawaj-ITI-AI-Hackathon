        ...
        <div class="form-grid">
          ...
          <div class="gd-card">
            ...
            <mat-form-field appearance="outline">
              ...
              <i class="fa-solid fa-envelope" matPrefix></i>
            </mat-form-field>
            <div class="form-row">
              <mat-form-field appearance="outline">
                <mat-label>{{ 'auth.phone' | translate }}</mat-label>
                <input matInput type="tel" formControlName="phone">
                <i class="fa-solid fa-phone" matPrefix></i>
              </mat-form-field>
              <mat-form-field appearance="outline">
