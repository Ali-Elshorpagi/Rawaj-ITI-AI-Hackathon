...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink, MatFormFieldModule, MatInputModule, MatButtonModule, MatRadioModule, TranslateModule],
  template: `
    <div class="page">
        ...
        <div class="gd-card">
          ...
          <div class="qr-scan-area" (click)="activateQRScan()">
            @if (!qrActive()) {
              ...
              <i class="fa-solid fa-qrcode" style="font-size:64px;color:var(--color-success-600)"></i>
  ...
  styles: [`
    ...
    .success-card { display: flex; align-items: center; gap: 12px; padding: 12px; background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: var(--radius-md); margin-top: 16px; i { font-size: 32px; color: var(--color-success-600); } }
