...
export const routes: Routes = [
  ...
  // ── Dashboard Layout ─────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      {
        path: 'subscribe',
        canActivate: [roleGuard([UserRole.MEMBER])],
        loadComponent: () => import('./features/member/subscribe/member-subscribe.component').then(m => m.MemberSubscribeComponent),
        title: 'Subscribe – GymDesk',
      },
      {
        path: 'members',
