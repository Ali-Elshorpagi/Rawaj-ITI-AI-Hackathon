...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MatIconModule, MatButtonModule, MatFormFieldModule, MatInputModule, MatSlideToggleModule, MatSelectModule, TranslateModule],
  template: `
    <div class="page">
          ...
          @if (activeSection() === 'about') {
            <div class="settings-section gd-card">
              ...
              <div class="about-content">
                <div class="app-logo">
                  <mat-icon style="font-size:48px;width:48px;height:48px;color:var(--color-primary-500)">fitness_center</mat-icon>
                </div>
                <h2>GymDesk</h2>
  ...
  styles: [`
    ...
    .settings-nav__item { display: flex; align-items: center; gap: 10px; padding: 10px 14px; border: none; border-radius: var(--radius-md); background: transparent; color: var(--text-secondary); font-size: 0.875rem; font-weight: 500; cursor: pointer; text-align: left; transition: all var(--transition-base); mat-icon { font-size: 18px; width: 18px; height: 18px; } }
