...
import { ApiResponse, PaginatedResponse, Notification } from '../models/interfaces';
...
export class NotificationsService extends ApiService {
  ...
  getAll(params?: { unread?: boolean; page?: number; limit?: number }): Observable<PaginatedResponse<Notification>> {
    return this.get<PaginatedResponse<Notification>>('/notifications', params as any);
  }
  ...
  markAsRead(id: string): Observable<ApiResponse<null>> {
    return this.patch<ApiResponse<null>>(`/notifications/${id}/read`, {}).pipe(
